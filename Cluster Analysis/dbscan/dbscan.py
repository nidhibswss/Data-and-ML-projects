...
# 2. Concatenate the dataframes 'data' and 'clustersLabels' (hint: use 'axis = 1' for concatenating along the column axis)
...
#  How many clusters were found? Fill out the blank to tell, and don't include the noise points in the count.
# There are _____ clusters, not including the noise 
print()
print("There are total of 9 clusters, not including the noise")
